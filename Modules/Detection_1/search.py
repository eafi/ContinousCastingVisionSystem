...
def search(src_img,  roi_size=512, board_size_range=[100,200,5], kernel_size=(200, 200), outer_diameter_range=(30, 80), ring_width_range=(5, 8), ring_threshold=[0.5,0.8,0.05],
